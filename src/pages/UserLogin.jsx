...
const UserLoginPage = () => {
  const {
    ...
    cartItems,
    setCartItems,
    handleLoginSuccess, // ✅ replaces manual setIsAuthentified + setToken + localStorage calls
    ...
    try {
      ...
      if (isLogin && !isReset) {
        ...
        if (res.ok) {
          ...
          // ✅ Single call handles user, token, loginTime, lastActive, isAuthentified
        ...
        <div className="relative bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden">
          ...
          {isLogin && !isReset && (
            <form onSubmit={handleSubmit} className="p-8 flex flex-col gap-4">
              ...
              <input
                ...
                className="w-full p-3 rounded-lg border-2 border-gray-300 focus:border-black outline-none"
                required
              />
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full p-3 pr-10 rounded-lg border-2 border-gray-300 focus:border-black outline-none"
                  required
                />
                <button
                  type="button"
          ...
          {isReset && (
            <form onSubmit={handleResetPassword} className="p-8 flex flex-col gap-4">
              ...
              <button
                type="button"
                onClick={() => { setIsReset(false); resetInputs(); }}
